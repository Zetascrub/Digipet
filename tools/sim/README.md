...
tools/sim/render.sh status-actions /tmp/actions.png   # Status page's action grid, page 1
tools/sim/render.sh status-actions2 /tmp/actions2.png #  ...page 2 (ITEMS + 3 locked tiles)
